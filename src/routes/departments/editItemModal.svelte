...
>
	<div class="internal">
		<h2 class="title">Edit properties for {currentSelectedList.departmentname}</h2>
		...
		<form method="POST" action="?/edit" id="form">
			<div class="grid grid-cols-3 gap-y-4">
				...
				<input type="hidden" name="categorynameoriginal" value={currentSelectedList.departmentname}>
				<h2 class="my-auto grid" id="categoryname">Edit department name: </h2>
				<input class="box" type="text" name="categoryname" autocomplete="off" value={currentSelectedList.departmentname} required>

...
>
    ...
    <h2 class="mx-auto w-fit">Are you sure you want to delete category: {currentSelectedList.categoryname}?</h2>
	{#if form?.error}
	...
	<div class="internal">
		<form method="POST" action="?/delete">
			...
			<input type="hidden" name="categoryname" value={currentSelectedList.categoryname}>
